    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isLoading)) {
        ...
        if (__props.searchKeyword) {
          _push(`<div data-v-25867357><span data-v-25867357>${ssrInterpolate(unref(filteredNewsCount))} notícias encontradas para a sua busca <b data-v-25867357>${ssrInterpolate(__props.searchKeyword)}</b></span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--[-->`);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "__app" }, _attrs))} data-v-956035a2><div class="app__wrapper" data-v-956035a2><div class="app__container" data-v-956035a2><div class="home-wrapper" data-v-956035a2><section class="home-news" data-v-956035a2><div class="home-news__header" data-v-956035a2><h1 class="home-news__title" data-v-956035a2>Últimas Notícias</h1>`);
